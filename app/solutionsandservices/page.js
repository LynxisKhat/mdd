...
export default function SolutionsAndServices() {
  ...
  const tabContent = {
      ...
      <div className="grid min-[940px]:grid-cols-2 grid-cols-1 mt-4 md:mt-8 m-10 items-center justify-center min-[940px]:items-center min-[940px]:justify-center">
        <div className="p-15">
          <h1 className="font-bold text-lg">
            Manufacturing activities under Production Management System.
          </h1>
          <p className="leading-5 mt-5">
            Production Management is to manage the process of converting inputs
            into the desired outputs in manufacturing.
          </p>
          <p className="my-5">
            The aim of production is to provide goods and services for mankind.
          </p>
    ...
    tab2: (
      <div className="grid min-[940px]:grid-cols-2 grid-cols-1 mt-4 md:mt-8 m-10 items-center justify-center min-[940px]:items-center min-[940px]:justify-center">
        <div className="p-15">
          ...
          <p className="leading-5 mt-5">
            Developing services with Informatica products especially in Power
            Center , Cloud Data Integration , PC2IDMC.
          </p>
    ...
    tab3: (
      <div className="grid min-[940px]:grid-cols-2 grid-cols-1 mt-4 md:mt-8 m-10 items-center justify-center min-[940px]:items-center min-[940px]:justify-center">
        <div className="p-15">
          ...
          <p className="my-5">
            Automation the process of modernizing PowerCenter to Informatica's
            Cloud-Native IICS platform.
          </p>
          <p>
            Able to take full advantage of your new Cloud Data Warehouse faster,
            retire legacy workloads sooner, and lower risk than any other
            alternative.
          </p>
        </div>
        <Image
    ...
    tab4: (
      <div className="grid min-[940px]:grid-cols-2 grid-cols-1 mt-4 md:mt-8 m-10 items-center justify-center min-[940px]:items-center min-[940px]:justify-center">
        <div className="p-15">
          <h1 className="font-bold text-lg">Global Customer Support</h1>
          <p>
            <ul className="leading-loose">
              <li>
                <Image
              ...
              <li>
                GCS Team provide the service to the customers not only
                informatica (CDI,CAI) but also PWC and also PC2IDMC.
              </li>
              <li className="mt-5">
                <Image
                  className="inline-block mr-2"
        ...
        <div className="p-15">
          <h1 className="font-bold text-lg">Local Customer Help-Desk</h1>
          <p>
            <ul className="leading-loose">
              <li>
                <Image
              ...
              <li>
                We provide the production management system as the help-desk
                between End user and product owner.
              </li>
              <li className="mt-5">
                <Image
                  className="inline-block mr-2"
      ...
      <div className="flex flex-col items-center relative pt-10 pb-10 ">
        <div className="relative flex flex-col items-center mt-2 md:mt-4 mb-3 md:mb-6">
          ...
          <div className="flex flex-row items-center gap-5 justify-center mt-5">
            <h5>
              How can we help you with your projects? Find out for yourself!
            </h5>
          </div>
        </div>
      </div>
